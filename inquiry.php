<?php
  ...
  if(@$_POST['sub'])
  {
    ...
    $qry = "INSERT INTO `inquiry`(`name`,`contact_number`,`parent_contact`,`course_name`,`course_content`,`course_fees`,`reference`,`reference_name`,`enquiry`,`added`,`expected_join`,`batch_time`,`status`,`followup_details`,`inquiry_details`) VALUES ('$name','$contact_number','$parent_contact','$course_name','$course_content','$course_fees','$reference','$reference_name','$enquiry','$added','$expected_join','$batch_time','$status','$followup_details','$inquiry_details')";
              ...
              <form method="POST">
                <div class="card-body d-flex flex-wrap">
                  ...
                  <div class="form-group col-4">
                    ...
                    <input type="text" class="form-control" placeholder="Enter Parent Contact" name="parent_contact">
                  </div>
                  <div class="form-group col-4">
                    <label for="Link">Select Course</label>
                    <input type="text" class="form-control" placeholder="Select Course Name..." name="course_name">
                  </div>
                  <div class="form-group col-4">
                    <label for="Link">Course Content</label>
                    <input type="text" class="form-control" placeholder="Course Extra Details..." name="course_content">
                  </div>
                  <div class="form-group col-4">
                    <label for="Link">Course Fees</label>
                    <input type="text" class="form-control" placeholder="Course Fees" name="course_fees">
                  </div>
                  <div class="form-group col-4">
                    ...
                    <div class="form-group col-4">
                        ...
                        <input type="text" class="form-control" placeholder="Enter Reference Name" name="reference_name">
                    </div>
                    <div class="form-group col-4">
                      ...
                      <div class="form-group col-4">
                          ...
                          <input type="date" class="form-control"  name="expected_join">
                        </div>
                        <div class="form-group col-4">
                        ...
                        <div class="form-group col-4">
                            ...
                            <input type="text" class="form-control" placeholder="Enter Followup Details"  name="followup_details">
                          </div>
                        <div class="form-group col-4">
                            <label for="Link">Inquiry Details</label>
                            <input type="text" class="form-control" placeholder="Enter Inquiry Details"  name="inquiry_details">
                          </div>
