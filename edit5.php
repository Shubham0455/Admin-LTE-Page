<?php
  ...
  if(@$_POST['sub'])
  {
    ...
    {
      $qry = "INSERT INTO `sub`(`sub_name`, `sub_title`, `sub_link`, `sub_image`) VALUES ('$name','$title','$link','$image')";
              ...
              <form method="POST" enctype="multipart/form-data">
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" placeholder="<?php echo $row['sub_name']; ?>" name="name"> 
                  </div>
                  <div class="form-group">
                    <label for="Title">Course Title</label>
                    <input type="text" class="form-control" placeholder="<?php echo $row['sub_title']; ?>" name="title">
                  </div>
                  <div class="form-group">
                    <label for="Link">Course Link</label>
                    <input type="text" class="form-control" placeholder="<?php echo $row['sub_link']; ?>" name="link">
                  </div>
                  <div class="form-group">
