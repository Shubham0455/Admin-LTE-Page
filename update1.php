<?php
  ...
  if(@$_POST['sub'])
  {
    ...
    $qry = "UPDATE `new_user` SET `first_name`='$first_name',`last_name`='$last_name',`address`='$address',`city`='$city',`state`='$state',`pin_code`='$pin_code',`phone_number`='$phone_number',`email_address`='$email_address',`date_of_birth`='$date_of_birth',`place_of_birth`='$place_of_birth',`gender`='$gender',`marital_status`='$marital_status',`language_name`='$language_name' WHERE `id` = '$id'";
              ...
              <form method="POST">
                <div class="card-body d-flex flex-wrap">
                  ...
                  <div class="form-group col-4">
                    ...
                    <input type="text" class="form-control" value="<?php echo $row['pin_code']; ?>" name="pin_code">
                  </div>
                  <div class="form-group col-8">
                  ...
                  <div class="form-group col-12">
                    ...
                    <input type="text" class="form-control" value="<?php echo $row['email_address']; ?>" name="email_address">
                  </div>
                  <div class="form-group col-4">
                    <label for="Title">Date Of Birth</label>
                    <input type="date" class="form-control" value="<?php echo $row['date_of_birth']; ?>" name="date_of_birth" >
                  </div>
                  <div class="form-group col-8">
                    <label for="Title">Place Of Birth</label>
                    <input type="text" class="form-control" value="<?php echo $row['place_of_birth']; ?>" name="place_of_birth">
                  </div>
                  <div class="form-group col-4">
                  ...
                  <div class="form-group col-4">
                    ...
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="marital_status" value="Single,Naver Married"<?php if($row['marital_status'] == "Single,Naver Married"){echo "checked";} ?>>
                          Single, Naver married
                        </label>
                    </div>
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="marital_status" value="Single, Naver Divorced"<?php if($row['marital_status'] == "Single, Naver Divorced"){echo "checked";} ?>>
                        Single, Naver Divorced
                        </label>
                    </div>
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="marital_status" value="Married"<?php if($row['marital_status'] == "Married"){echo "checked";} ?>>
                          Married
                        </label>
                    </div>
                  </div>
                  ...
                  <input type="text" class="form-control" value="<?php echo $row['language_name'] ?>" name="language_name">
                </div>     
                    <input type="submit" class="btn btn-primary" name="sub" value="Submit">&nbsp;
                    <button class="btn btn-primary"><a href="viewapp.php" class="btn-primary">View</a></button>
              </form>
            </div>
                </form>
              </div>
