<?php
  ...
  {
    $id = $_GET['id'];
    $query1 = "SELECT * FROM `inquiry` WHERE `id`='$id'";
  ...
  if(@$_POST['sub'])
  {
    ...
    $qry = "INSERT INTO `followup`(`inquiry_name`, `inquiry_contact`, `inquiry_course`, `inquiry_by`, `followup_reason`, `expected_join_date`, `follow_up_by`) VALUES ('$inquiry_name','$inquiry_contact','$inquiry_course','$inquiry_by','$followup_reason','$expected_join_date','$follow_up_by')";
              ...
              <form method="POST" enctype="multipart/form-data">
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" value ="<?php echo @$row1['name'] ?>" name="inquiry_name"> 
                  </div>
                  <div class="form-group">
                    <label for="Title">Inquiry Contact</label>
                    <input type="text" class="form-control" value ="<?php echo @$row1['contact_number'] ?>"  name="inquiry_contact">
                  </div>
                  <div class="form-group">
                    <label for="Link">Inquiry Course</label>
                    <input type="text" class="form-control" value ="<?php echo @$row1['course_name'] ?>"  name="inquiry_course">
                  </div>
                  <div class="form-group">
                    <label for="Link">Inquiry By</label>
                    <input type="text" class="form-control" value ="<?php echo @$row1['enquiry'] ?>"  name="inquiry_by">
                  </div>
                  <div class="form-group">
                    <label for="Link">Followup Reason</label>
                    <input type="text" class="form-control" placeholder="Followup Reason" name="followup_reason">
                  </div>
                  <div class="form-group">
                    <label for="Link">Expected Join Date</label>
                    <input type="date" class="form-control" placeholder="Expected Join Date" name="expected_join_date">
                  </div>
                  <div class="form-group">
