<?php
    ...
    {
        $src = $_POST['src'];
        $qry  = "SELECT * FROM `inquiry` WHERE `name` LIKE '%$src%'";
    }
    else{
                  ...
                  <div class="input-group input-group-sm">
                    <input type="text" name="src" class="form-control float-right" placeholder="Search">
                      <div class="input-group-append">
                        ...
                        <button><a href="simple.php">back</a></button>
                      </div>
                    </div>
                  </form>
                  </div>
                      ...
                      while($row = mysqli_fetch_assoc($run))
                      {
                        ?>
                          <tr>
                              ...
                              <td><?php echo $row['expected_join'];?></td>
                              <td><?php echo $row['batch_time'];?></td>
                              <td><?php echo $row['status'];?></td>
                              <td><?php echo $row['followup_details'];?></td>
                              <td><?php echo $row['inquiry_details'];?></td>
                              <td><a href="update.php?id=<?php echo $row['id'];?>">Edit</a></td>
                              <td><a href="deletein.php?id=<?php echo $row['id'];?>">Delete</a></td>
                              <td><a href="followup.php?id=<?php echo $row['id'];?>">Add follow up</a></td>
                          </tr>
                          <?php
                      }
                    ?>
