<?php
    ...
    {
        $src = $_POST['src'];
        $qry  = "SELECT * FROM `followup` WHERE `inquiry_name` LIKE '%$src%'";
    }
    else{
            ...
            <div class="card">
              <div class="card-header">
                ...
                <div class="card-tools">
                  <form method="POST">
                  <div class="input-group input-group-sm">
                    <input type="text" name="src" class="form-control float-right" placeholder="Search">
                      <div class="input-group-append">
                        <input type="submit" class="fas fa-search" name="search">
                        <button><a href="viewinfo.php">back</a></button>
                      </div>
                    </div>
                  </form>
                  </div>
                      ...
                      while($row = mysqli_fetch_assoc($run))
                      {
                        ?>
                          <tr>
                              ...
                              <td><?php echo $row['inquiry_name'];?></td>
                              <td><?php echo $row['inquiry_contact'];?></td>
                              <td><?php echo $row['inquiry_course'];?></td>
                              <td><?php echo $row['inquiry_by'];?></td>
                              <td><?php echo $row['followup_reason'];?></td>
                              <td><?php echo $row['expected_join_date'];?></td>
                              <td><?php echo $row['follow_up_by'];?></td>
                              <td><a href="e.php?id=<?php echo $row['id'];?>">Edit</a></td>
                              <td><a href="d.php?id=<?php echo $row['id'];?>">Delete</a></td>
                          </tr>
                          <?php
                      }
                    ?>
