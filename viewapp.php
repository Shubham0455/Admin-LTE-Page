<?php
    ...
    {
        $src = $_POST['src'];
        $qry  = "SELECT * FROM `new_user` WHERE `first_name` LIKE '%$src%'";
    }
    else{
        $qry = "SELECT * FROM `new_user`";
    }
                      ...
                      while($row = mysqli_fetch_assoc($run))
                      {
                        ?>
                          <tr>
                              ...
                              <td><a href="update1.php?id=<?php echo $row['id'];?>">Edit</a></td>
                              <td><a href="deletein1.php?id=<?php echo $row['id'];?>">Delete</a></td>
                          </tr>
                          <?php
                      }
                    ?>
