<?php
  ...
  if(@$_POST['sub'])
  {
    ...
    $added = $_POST['added'];
    $expected_join = $_POST['expected_join'];
    $batch_time = $_POST['batch_time'];
    $status = $_POST['status'];
    $followup_details = $_POST['followup_details'];
    $inquiry_details = $_POST['inquiry_details'];
    
    $qry = "UPDATE `inquiry` SET `name`='$name',`contact_number`='$contact_number',`parent_contact`='$parent_contact',`course_name`='$course_name',`course_content`='$course_content',`course_fees`='$course_fees',`reference`='$reference',`reference_name`='$reference_name',`enquiry`='$enquiry',`added`='$added',`expected_join`='$expected_join',`batch_time`='$batch_time',`status`='$status',`followup_details`='$followup_details',`inquiry_details`='$inquiry_details' WHERE `id` = '$id'";
        ...
        <div class="navbar-search-block">
          <form class="form-inline">
            <div class="input-group input-group-sm">
              <input class="form-control form-control-navbar" type="search" value="Search" aria-label="Search">
    ...
    <div class="sidebar">
      ...
      <div class="form-inline">
        <div class="input-group" data-widget="sidebar-search">
          <input class="form-control form-control-sidebar" type="search" value="Search" aria-label="Search">
          <div class="input-group-append">
      ...
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <ul class="nav nav-treeview">
          ...
          <li class="nav-item">
            <a href="pages/forms/subdata.php" class="nav-link">
              <i class="far fa-circle nav-icon"></i>
              <p>Add sub Course</p>
            </a>
          </li>
          <li class="nav-item">
            <a href="pages/tables/sub.php" class="nav-link">
              <i class="far fa-circle nav-icon"></i>
              <p>Viwe sub Course</p>
            </a>
          </li>
              ...
              <form method="POST">
                <div class="card-body d-flex flex-wrap">
                  ...
                  <div class="form-group col-4">
                    ...
                    <input type="text" class="form-control" value="<?php echo $row['contact_number']; ?>" name="contact_number">
                  </div>
                  <div class="form-group col-4">
                    <label for="Link">Parent Contact</label>
                    <input type="text" class="form-control" value="<?php echo $row['parent_contact']; ?>" name="parent_contact">
                  </div>
                  <div class="form-group col-4">
                    <label for="Link">Select Course</label>
                    <input type="text" class="form-control" value="<?php echo $row['course_name']; ?>" name="course_name">
                  </div>
                  <div class="form-group col-4">
                    <label for="Link">Course Content</label>
                    <input type="text" class="form-control" value="<?php echo $row['course_content']; ?>" name="course_content">
                  </div>
                  <div class="form-group col-4">
                    <label for="Link">Course Fees</label>
                    <input type="text" class="form-control" value="<?php echo $row['course_fees']; ?>" name="course_fees">
                  </div>
                  <div class="form-group col-4">
                      <label for="Link">Select Reference</label>
                      <select name="reference" class="form-control">
                          <option value=""<?php if(@$reference == '') { echo 'selected';}?>>Select Reference</option>
                          <option value="father"<?php if(@$reference == 'father') { echo 'selected';}?>>father</option>
                          <option value="mother"<?php if(@$reference == 'mother') { echo 'selected';}?>>mother</option>
                          <option value="brother"<?php if(@$reference == 'brother') { echo 'selected';}?>>brother</option>
                          <option value="sister"<?php if(@$reference == 'sister') { echo 'selected';}?>>sister</option>
                          <option value="friend"<?php if(@$reference == 'friend') { echo 'selected';}?>>friend</option>
                        </select>  
                    </div>
                    <div class="form-group col-4">
                        <label for="Link">Reference Name</label>
                        <input type="text" class="form-control" value="<?php echo $row['reference_name']; ?>" name="reference_name">
                    </div>
                    <div class="form-group col-4">
                        <label for="Link">Enquiry by</label>
                        <select name="enquiry" class="form-control">
                            <option value="">Select inquiry By</option>
                            <option value="Deepen"<?php if(@$enquiry == 'Deepen') { echo 'selected';}?>>Deepen</option>
                            <option value="Tushar"<?php if(@$enquiry == 'Tushar') { echo 'selected';}?>>Tushar</option>
                            <option value="Jatin"<?php if(@$enquiry == 'Jatin') { echo 'selected';}?>>Jatin</option>
                            <option value="Yash"<?php if(@$enquiry == 'Yash') { echo 'selected';}?>>Yash</option>
                            <option value="Piyush"<?php if(@$enquiry == 'Piyush') { echo 'selected';}?>>Piyush</option>
                        </select>  
                      </div>  
                      <div class="form-group col-4">
                          <label for="Link">Added by</label>
                      ...
                      <div class="form-group col-4">
                          <label for="Link">Expected join Date</label>
                          <input type="date" class="form-control" value="<?php echo $row['expected_join']; ?>"  name="expected_join">
                        </div>
                        <div class="form-group col-4">
                            <label for="Link">Batch Time</label>
                            <select name="batch_time" class="form-control">
                                <option value="">Select Batch Time</option>
                                <option value="8 to 10"<?php if(@$batch_time == '8 to 10') { echo 'selected';}?>>8 to 10</option>
                                <option value="10 to 12"<?php if(@$batch_time == '10 to 12') { echo 'selected';}?>>10 to 12</option>
                                <option value="12 to 2"<?php if(@$batch_time == '12 to 2') { echo 'selected';}?>>12 to 2</option>
                                <option value="2 to 4"<?php if(@$batch_time == '2 to 4') { echo 'selected';}?>>2 to 4</option>
                                <option value="4 to 6"<?php if(@$batch_time == '4 to 6') { echo 'selected';}?>>4 to 6</option>
                                <option value="6 to 8"<?php if(@$batch_time == '6 to 8') { echo 'selected';}?>>6 to 8</option>
                            </select>  
                        </div>  
                        <div class="form-group col-4">
                        ...
                        <div class="form-group col-4">
                            <label for="Link">Followup Details</label>
                            <input type="text" class="form-control" value="<?php echo $row['followup_details']; ?>"  name="followup_details">
                          </div>
                        <div class="form-group col-4">
                            <label for="Link">Inquiry Details</label>
                            <input type="text" class="form-control" value="<?php echo $row['inquiry_details']; ?>"  name="inquiry_details">
                          </div>
