<?php
  ...
  if(@$_POST['sub'])
  {
    ...
    $qry = "INSERT INTO `new_user`(`first_name`, `last_name`, `address`, `city`, `state`, `pin_code`, `phone_number`, `email_address`, `date_of_birth`, `place_of_birth`, `gender`, `marital_status`, `language_name`) VALUES ('$first_name','$last_name','$address','$city','$state','$pin_code','$phone_number','$email_address','$date_of_birth','$place_of_birth','$gender','$marital_status','$language_name')";
              ...
              <form method="POST">
                <div class="card-body d-flex flex-wrap">
                  ...
                  <div class="form-group col-8">
                    ...
                    <input type="text" class="form-control" placeholder="(___) ___ ___" name="phone_number">
                  </div>
                  <div class="form-group col-12">
                  ...
                  <div class="form-group col-4">
                    ...
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="marital_status" value="Single,Naver Married">
                          Single, Naver married
                        </label>
                    </div>
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="marital_status" value="Single, Naver Divorced">
                  ...
                  <input type="text" class="form-control" placeholder="which language you can use for work" name="language_name">
                </div>     
