<?php
  ...
  if(@$_POST['sub'])
  {
    ...
    if($name != "" && $email != "" && $pass != "" && $file != "image/".$file )
    {
      $qry = "INSERT INTO `user` (`name`, `email`, `password`,`image`) VALUES ('$name', '$email', '$pass','$file')";
    ...
    <div class="card-body register-card-body">
      ...
      <form method="POST" enctype="multipart/form-data">
        ...
        <div class="row">
          ...
          <div class="col-4">
            <input type="submit" name="sub" class="btn btn-primary btn-block" value="Register">
          </div>
        </div>
      </form>
