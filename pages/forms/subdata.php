<?php
  ...
  if(@$_POST['submit'])
  {
    ...
    move_uploaded_file($_FILES['sub_image']['tmp_name'],"../../image/".$image);
    if($name != "" && $title != "" && $link != "" && $image != "image/".$image)
    {
      $query = "INSERT INTO `sub`(`sub_name`, `sub_title`, `sub_link`, `sub_image`) VALUES ('$name','$title','$link','$image')";
    ...
    <div class="sidebar">
      ...
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <ul class="nav nav-treeview">
          ...
          <li class="nav-item">
            <a href="subdata.php" class="nav-link">
              <i class="far fa-circle nav-icon"></i>
              <p>Add sub Course</p>
            </a>
          </li>
          <li class="nav-item">
            <a href="../tables/sub.php" class="nav-link">
              <i class="far fa-circle nav-icon"></i>
              <p>Viwe sub Course</p>
            </a>
          </li>
              ...
              <form method="POST" enctype="multipart/form-data">
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" placeholder="Course Title" name="sub_title">
                  </div>
                  <div class="form-group">
                    <label for="Link">Course Link</label>
                    <input type="text" class="form-control" placeholder="Course Link" name="sub_link">
                  </div>
                  <div class="form-group">
                    <label for="image">Upload Image</label>
                    <div class="input-group">
                      <div class="custom-file">
                        <input type="file" class="custom-file-input" name="sub_image">
