<?php
    ...
    {
        $src = $_POST['src'];
        $qry  = "SELECT * FROM `add` WHERE `name` LIKE '%$src%'";
    }
    else{
        $qry = "SELECT * FROM `add`";
    }
                      ...
                      while($row = mysqli_fetch_assoc($run))
                      {
                        ?>
                          <tr>
                              ...
                              <td>
                                <img src="../../image/<?php echo $row['image'];?>" alt="image not found" width="100px" height="50px">
                              </td>
                              <td><a href="../../simpleedit.php?id=<?php echo $row['id'];?>">Edit</a></td>
