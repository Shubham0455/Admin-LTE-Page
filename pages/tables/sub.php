<?php
    ...
    {
        $src = $_POST['src'];
        $qry  = "SELECT * FROM `sub` WHERE `name` LIKE '%$src%'";
    }
    else{
        $qry = "SELECT * FROM `sub`";
    }
    ...
    <div class="sidebar">
      ...
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <ul class="nav nav-treeview">
          ...
          <li class="nav-item">
            <a href="../forms/subdata.php" class="nav-link">
              <i class="far fa-circle nav-icon"></i>
              <p>Add sub Course</p>
            </a>
          </li>
                      ...
                      while($row = mysqli_fetch_assoc($run))
                      {
                        ?>
                          <tr>
                              ...
                              <td><?php echo $row['sub_link'];?></td>
                              <td>
                                <img src="../../image/<?php echo $row['sub_image'];?>" alt="image not found" width="100px" height="50px">
                              </td>
                              <td><a href="../../edit5.php?id=<?php echo $row['id'];?>">Edit</a></td>
