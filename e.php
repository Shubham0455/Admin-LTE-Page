<?php
  ...
  {
    $id = $_GET['id'];
    $query1 = "SELECT * FROM `followup` WHERE `id`='$id'";
  ...
  if(@$_POST['sub'])
  {
    ...
    $inquiry_contact = $_POST['inquiry_contact'];
    $inquiry_course = $_POST['inquiry_course'];
    $inquiry_by = $_POST['inquiry_by'];
    $followup_reason = $_POST['followup_reason'];
    $expected_join_date = $_POST['expected_join_date'];
    $follow_up_by = $_POST['follow_up_by'];
    $qry = "UPDATE `followup` SET `inquiry_name`='$inquiry_name',`inquiry_contact`='$inquiry_contact',`inquiry_course`='$inquiry_course',`inquiry_by`='$inquiry_by',`followup_reason`='$followup_reason',`expected_join_date`='$expected_join_date',`follow_up_by`='$follow_up_by' WHERE `id` = '$id'";
              ...
              <form method="POST" enctype="multipart/form-data">
                <div class="card-body">
                  <div class="form-group">
                    <label for="Name">Inquiry Name</label>
                    <input type="text" class="form-control" value ="<?php echo @$row1['inquiry_name'] ?>" name="inquiry_name"> 
                  </div>
                  <div class="form-group">
                    <label for="Title">Inquiry Contact</label>
                    <input type="text" class="form-control" value ="<?php echo @$row1['inquiry_contact'] ?>"  name="inquiry_contact">
                  </div>
                  <div class="form-group">
                    <label for="Link">Inquiry Course</label>
                    <input type="text" class="form-control" value ="<?php echo @$row1['inquiry_course'] ?>"  name="inquiry_course">
                  </div>
                  <div class="form-group">
                    <label for="Link">Inquiry By</label>
                    <input type="text" class="form-control" value ="<?php echo @$row1['inquiry_by'] ?>"  name="inquiry_by">
                  </div>
                  <div class="form-group">
                    <label for="Link">Followup Reason</label>
                    <input type="text" class="form-control" value ="<?php echo @$row1['followup_reason'] ?>"  name="followup_reason">
                  </div>
                  <div class="form-group">
                    <label for="Link">Expected Join Date</label>
                    <input type="date" class="form-control" value ="<?php echo @$row1['expected_join_date'] ?>"  name="expected_join_date">
                  </div>
                  <div class="form-group">
                    <label for="Link">Follow- Up By</label>
                    <select name="follow_up_by" class="form-control">
                        <option value="">Select follow_up_by</option>
                        <?php
                          while($row = mysqli_fetch_assoc($run)) {
                            ?>
                            <option value="<?php echo $row['name']?>" <?php if($row1['follow_up_by'] == $row['name']){ echo 'selected';}?>><?php echo $row['name']?></option>
                            <?php
                          }
                       ?>
                    </select>
